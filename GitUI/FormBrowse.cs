...
namespace GitUI
{
    public partial class FormBrowse : GitExtensionsForm
    {
        ...
        {
            new FormProcess("gc", "gc").ShowDialog(this);
        }
        ...
        {
            new FormProcess("stash save", "StashSave").ShowDialog(this);
            Initialize();
        }

        private void StashPopToolStripMenuItemClick(object sender, EventArgs e)
        {
            new FormProcess("stash pop", "StashApply").ShowDialog(this);
            Initialize();
        }
        ...
        {
            new FormProcess(Settings.Module.FetchCmd(string.Empty, string.Empty, string.Empty), "QuickFetch").ShowDialog(this);
            Initialize();
        }
