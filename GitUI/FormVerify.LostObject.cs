    ...
    partial class FormVerify
    {
        ...
        private sealed class LostObject
        {
            ...
            public static LostObject TryParse(string raw)
            {
                ...
                if (result.ObjectType == LostObjectType.Commit)
                {
                    ...
                    if (logPatternMatch.Success)
                    {
                        ...
                        result.Subject = GitCommandHelpers.ReEncodeStringFromLossless(logPatternMatch.Groups[3].Value, encodingName);
            ...
            private static string GetLostCommitLog(string hash)
            {
                ...
                return GitCommandHelpers.RunCmd(Settings.GitCommand, string.Format(LogCommandArgumentsFormat, hash), GitCommandHelpers.SetLosslessEncodingDelegate);
            }
