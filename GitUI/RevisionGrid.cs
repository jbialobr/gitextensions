...
namespace GitUI
{
    ...
    public partial class RevisionGrid : GitExtensionsControl
    {
        ...
        private void ToolStripItemClick(object sender, EventArgs e)
        {
            ...
            new FormProcess(GitCommandHelpers.DeleteTagCmd(toolStripItem.Text), "DeleteTag").ShowDialog(this);
            ForceRefreshRevisions();
        }
        ...
        private void ToolStripItemClickCheckoutBranch(object sender, EventArgs e)
        {
            ...
            new FormProcess("checkout \"" + toolStripItem.Text + "\"", "Checkout").ShowDialog(this);
        ...
        private void CheckoutRevisionToolStripMenuItemClick(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(this, "Are you sure to checkout the selected revision", "Checkout revision",
                ...
                return;
            new FormProcess(string.Format("checkout \"{0}\"", GetRevision(LastRow).Guid), "Checkout").ShowDialog(this);
            ForceRefreshRevisions();
            OnActionOnRepositoryPerformed();
        }
        ...
        private void markRevisionAsBadToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            new FormProcess(GitCommandHelpers.MarkRevisionBisectCmd(false, GetRevision(LastRow).Guid), FormBisect.FormSettingsName()).ShowDialog(this);
            RefreshRevisions();
        }
        ...
        private void markRevisionAsGoodToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            new FormProcess(GitCommandHelpers.MarkRevisionBisectCmd(true, GetRevision(LastRow).Guid), FormBisect.FormSettingsName()).ShowDialog(this);
            RefreshRevisions();
        }

        private void stopBisectToolStripMenuItem_Click(object sender, EventArgs e)
        {
            new FormProcess(GitCommandHelpers.StopBisectCmd(), FormBisect.FormSettingsName()).ShowDialog(this);
            RefreshRevisions();
        }
