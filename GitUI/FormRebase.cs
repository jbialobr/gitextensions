...
namespace GitUI
{
    public partial class FormRebase : GitExtensionsForm
    {
        ...
        private void ResolvedClick(object sender, EventArgs e)
        {
            ...
            new FormProcess(GitCommandHelpers.ContinueRebaseCmd(), PerFormSettingsName()+"Resolved").ShowDialog(this);
        ...
        {
            Cursor.Current = Cursors.WaitCursor;
            new FormProcess(GitCommandHelpers.SkipRebaseCmd(), PerFormSettingsName()+"Skip").ShowDialog(this);
        ...
        {
            Cursor.Current = Cursors.WaitCursor;
            new FormProcess(GitCommandHelpers.AbortRebaseCmd(), PerFormSettingsName()+"Abort").ShowDialog(this);
