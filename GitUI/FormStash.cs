...
namespace GitUI
{
    public partial class FormStash : GitExtensionsForm
    {
        ...
        private void StashClick(object sender, EventArgs e)
        {
            ...
            new FormProcess(String.Format("stash save{0}{1}", Arguments, Msg), "StashSave").ShowDialog(this);
            NeedRefresh = true;
            Initialize();
            Cursor.Current = Cursors.Default;
        }
        ...
        {
            Cursor.Current = Cursors.WaitCursor;
            new FormProcess(string.Format("stash drop {0}", Stashes.Text), "StashDrop").ShowDialog(this);
            NeedRefresh = true;
            Initialize();
            Cursor.Current = Cursors.Default;
        }
        ...
        {
            new FormProcess(string.Format("stash apply {0}", Stashes.Text), "StashApply").ShowDialog(this);
