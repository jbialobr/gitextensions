...
namespace GitUI
{
    public static class GitUIExtensions
    {
        ...
        public static Task<string> ViewChanges(this FileViewer diffViewer, IList<GitRevision> revisions, GitItemStatus file, string defaultText)
        {
        ...
        public static Task<string> ViewChanges(this FileViewer diffViewer, string firstRevision, string secondRevision, GitItemStatus file, string defaultText)
        {
